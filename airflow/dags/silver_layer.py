...
aws_access_key_id="OPXhZ6gheHdXcafGDnyT"
aws_secret_access_key="9H16IKAZ1un2e8DQEkCNOLe3CY5WiJDG5S86tNa8"

s3 = boto3.client('s3', endpoint_url="http://localhost:9000", aws_access_key_id=aws_access_key_id, aws_secret_access_key=aws_secret_access_key, config=Config(signature_version='s3v4'))
